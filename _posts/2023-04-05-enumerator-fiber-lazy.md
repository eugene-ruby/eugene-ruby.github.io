...
Итераторы в Ruby — не просто `each`. За кулисами стоят `Enumerator`, `Fiber`, и целая философия: «Делай только то, что нужно». Идеально для продакшена — и собеседований.
