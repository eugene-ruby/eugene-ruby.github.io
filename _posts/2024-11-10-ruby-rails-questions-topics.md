...
Если ты дошёл до уровня Senior или только собираешься — эта шпаргалка поможет вспомнить всё, что любят спрашивать на технических собеседованиях: от `lambda` до `Ractor`, от `joins` до сломанных `includes`.
